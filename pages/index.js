...
function responsiveHome({ hideSidebar }) {
  ...
  return (
    <>
      <div className="w-full overflow-x-hidden pc:overflow-y-hidden temp:overflow-y-auto h-screen" onClick={hideSidebar}>
        <form
          className="flex justify-between items-center pc:ml-10 w-full mt-[23vh] mb-20 h-auto nav:flex-col temp:flex-col mobile:flex-col"
          method="post"
          id="voice_form"
        >
              ...
              >
                <div className="p-5">
                  ...
                  <div className="text-sm mb-4 text-white font-normal">
                    ...
                    Velit sunt ad optio vitae ex atque, vero excepturi quae
                    animi reiciendis veritatis temporibus laudantium repudiandae
                    deleniti.
                  </div>
                  <div className="">
      ...
      <div className="w-full absolute bottom-0 bg-gray-800 border-[0.25px] border-white py-1 px-0.5 mobile:py-0.5">
        <marquee
          behavior="scroll"
          scrollamount="9"
