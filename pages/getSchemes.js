...
export default function getSchemes({ schemes }) {
  ...
  return (
    <>
      <section className="bg-gradient-to-br from-[rgba(255,153,51,1)] via-white to-[rgba(19,136,8,1)] relative mt-24 flex justify-center w-full h-[89.75vh] overflow-y-hidden">
                ...
                {schemes.map((scheme, i) => {
                  return (
                    <tr className="border-b bg-gray-600" key={i}>
                      ...
                      <td className="py-4 px-6 cursor-pointer">{scheme.id}</td>
                      <td
